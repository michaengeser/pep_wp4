...
# accuracy - bathroom
hist_acc = ggplot(cate_table_bath, aes(x=trial_accuracy, fill=category)) +
  geom_histogram(alpha=0.6, position='identity') + xlim(c(0,2)) + ggtitle("Duration histogram")
hist_acc
...
SOA_SOA_lock_duration_subj_data3 = all_event_table %>% group_by(onset_SOA,SOA_lock, duration, sub_id, task_relevance) %>%
