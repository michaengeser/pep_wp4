...
output_struct.dur_diff_sd = sd(output_struct.dur_diff);
...
output_struct.ctr_mask_dur_diff_sd = sd(output_struct.ctr_mask_dur_diff);
...
output_struct.mask_dur_diff_sd = sd(output_struct.mask_dur_diff);
